...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html"><h1><span class="fa fa-diamond" aria-hidden="true"></span>骑手主页</h1></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#">接单</a></li>
				<li class="active"><a href="courierorders.html">物流详情</a></li>
				<li class="dropdown">
					<a class="couriersName" href="courierlogin.html" >
					<c:if test="${not empty courier}">欢迎${courier}</c:if>
					<c:if test="${empty courier}">登录</c:if>
					</a>
				</li>
			</ul>
        </div>
